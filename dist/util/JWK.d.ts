...
export declare type asymmetricKeyObjectTypes = "private" | "public";
export declare type keyObjectTypes = asymmetricKeyObjectTypes | "secret";
export declare type keyType = "RSA" | "EC" | "OKP" | "oct";
